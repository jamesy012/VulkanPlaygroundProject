...
void Application::Start() {
...

   {
      ...
      mWebUITest.SetupMaterials({ mSceneDescriptorSet,mObjectDescriptorSet,mMaterialDescriptorSet }, &mRenderPass);

      {
         ...
         vkAllocateDescriptorSets(mVkManager->GetDevice(), &setAllocate, &mWebUITest.GetDescriptorSet());
...
void Application::Draw() {
   ...
   //main render
   {
      ...
      mWebUITest.Render(commandBuffer, &mScreenQuad);
